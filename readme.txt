...
<header class="text-gray-400 bg-gray-900 body-font">
      ...
      >
        ...
        >
          <a class="mr-5 hover:text-white" a href="farmer.html">About Us</a>
          <a class="mr-5 hover:text-white" a href="business.html">abc</a>
          <a class="mr-5 hover:text-white">Services</a>
          <a class="mr-5 hover:text-white">Team</a>
        </nav>
